...
def edit_password(vault: Dict, username: str, vault_key: bytes) -> None:
    ...
    The user selects a service to edit and is prompted to update its username and/or password.
...
def password_menu(vault: Dict, username: str, vault_key: bytes) -> None:
    ...
    Each iteration clears the screen for a fresh view.
    """
    while True:
        clear_screen()  # Clears the previous outputs.
